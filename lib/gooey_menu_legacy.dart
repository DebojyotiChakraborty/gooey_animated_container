...
/// The original (pre-edit) gooey menu: a fixed, centered inline morph driven by
/// `Cue.onToggle`. Kept for side-by-side comparison with the new draggable menu.
class LegacyGooeyMenu extends StatefulWidget {
  const LegacyGooeyMenu({super.key});

  @override
  State<LegacyGooeyMenu> createState() => _LegacyGooeyMenuState();
}

class _LegacyGooeyMenuState extends State<LegacyGooeyMenu> {
  bool _open = false;
